...
export async function ArticleCard({
  ...
  return (
    <article
      ...
      className="group js-article-card flex flex-col overflow-hidden rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] transition hover:-translate-y-0.5 hover:shadow-lg data-[hidden-by-search=true]:hidden"
    >
